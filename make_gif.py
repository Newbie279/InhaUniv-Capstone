...
#source_dir = Path('./data/source/1/test_img')
source_dir = Path('./data/source/1/images')
target_dir = Path('./results1/target/test_latest/images')
#label_dir = Path('./data/source/1/test_label_ori')
...
anim = ani.FuncAnimation(fig, animate, frames=900, interval=500 / 24)
